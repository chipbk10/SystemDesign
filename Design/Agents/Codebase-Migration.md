## Technical Architecture: Autonomous Codebase Migration Agent## 1. Overview & Objective
...
## 3. The Core Architecture (Step-by-Step)## Step 1: Local Discovery Phase (Cost: $0)
